...
public class GuaranteeContract {
    ...
    private String repaymentPlanPdf; // 还款计划表url（未签署，主系统）

    private String repaymentPlanSignedPdf; // 还款计划表url（已签署）
    ...
    private String signRepaymentPlanServiceId; // 还款计划表签署记录id
    ...
    public GuaranteeContract(ApplicantContractDto applicantContractDto) {
