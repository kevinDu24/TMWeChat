 ...
 */
public class ApplyItemDeserialize {
    ...
    private static Map<String, Apply> listToMap(List<Apply> itemList) {
        Map<String, Apply> itemMap = new HashMap<>();
        for (Apply item : itemList) {
    ...
    public static <T> T deserialize(Class<T> beanClass, List<Apply> itemList) throws Exception {
        ...
        Map<String, Apply> itemMap = listToMap(itemList);

        return deserialize(null, beanClass, itemMap);

    }

    private static <T> T deserialize(String parentKey, Class<T> beanClass, Map<String, Apply> itemMap) throws Exception {
    ...
    private static <T> List<T> deserialize4List(String parentKey, Class<T> beanClass, ItemColumn itemColumn, Map<String, Apply> itemMap) throws Exception {
...
//            throw new RuntimeException("");
    ...
    private static <T> void deserialize4ListClass(String parentKey, Class<T> beanClass, Map<String, Apply> itemMap, int listSize, List resultList) throws Exception {
        String pathKey;
        T instance;
    ...
    private static <T> void deserialize4ListNormal(String parentKey, int type, Map<String, Apply> itemMap, int listSize, List resultList) throws Exception {
        String pathKey;
        Object o;
        StringBuffer stringBuffer;
        for (int i = 0; i < listSize; i++) {
    ...
    public static <T> void deserialize(String parentPathKey, T instance, Map<String, Apply> itemMap) throws Exception {
    ...
    private static Object deSerialize(String pathKey, Field field, ItemColumn itemColumn, Map<String, Apply> itemMap) throws Exception {
    ...
    private static Object deSerialize4Normal(String pathKey, int type, Map<String, Apply> itemMap) throws Exception {
        Object result;
        Apply item = itemMap.get(pathKey.trim());
        if (item == null) {
            return null;
        }
        switch (type) {
