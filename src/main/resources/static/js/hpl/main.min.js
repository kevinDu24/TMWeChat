...
(function() {
	function k() {
		if (k.is(arguments[0], da)) {
			for (var a = arguments[0], b = Ja[M](k, a.splice(0, 3 + k.is(a[0],
					X))), c = b.set(), e = 0, f = a[v]; e < f; e++) {
				var d = a[e] || {};
	...
	function O(a, b, c, e, f, d) {
		...
		var i = 3 * b, l = 3 * (e - b) - i, m = 1 - i - l, n = 3 * c, o = 3
				* (f - c) - n, s = 1 - n - o;
		return h(a, 1 / (200 * d))
	}
	k.version = "1.5.2";
	var C = /[, ]+/, fa = {
		...
		text : 1,
		image : 1
	}, qa = /\{(\d+)\}/g, p = "prototype", u = "hasOwnProperty", y = document, H = window, J = {
		was : Object[p][u].call(H, "Raphael"),
		is : H.Raphael
	}, na = function() {
		this.customAttributes = {}
	}, P, M = "apply", oa = "createTouch" in y, V = " ", D = String, sa = "click dblclick mousedown mousemove mouseout mouseover mouseup touchstart touchmove touchend orientationchange touchcancel gesturestart gesturechange gestureend"
			.split(V), Ka = {
		mousedown : "touchstart",
		mousemove : "touchmove",
		mouseup : "touchend"
	}, Y = "join", v = "length", pa = D[p].toLowerCase, G = Math, ca = G.max, ja = G.min, W = G.abs, Q = G.pow, aa = G.PI, X = "number", da = "array", ka = "toString", sb = Object[p][ka], N = "push", Wa = /^url\(['"]?([^\)]+?)['"]?\)$/i, tb = /^\s*((#[a-f\d]{6})|(#[a-f\d]{3})|rgba?\(\s*([\d\.]+%?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?)%?\s*\)|hsba?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?)%?\s*\)|hsla?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?)%?\s*\))\s*$/i, ub = {
		NaN : 1,
		Infinity : 1,
		"-Infinity" : 1
		...
		x : X,
		y : X
	}, wb = /^(from|to|\d+%?)$/, Ma = /\s*,\s*/, xb = {
		hs : 1,
		rg : 1
	}, yb = /,?([achlmqrstvxz]),?/gi, zb = /([achlmqstvz])[\s,]*((-?\d*\.?\d*(?:e[-+]?\d+)?\s*,?\s*)+)/ig, Ab = /(-?\d*\.?\d*(?:e[-+]?\d+)?)\s*,?\s*/ig, Xa = /^r(?:\(([^,]+?)\s*,\s*([^\)]+?)\))?/, Bb = function(
			a, b) {
		return a.key - b.key
	};
	k.type = H.SVGAngle
	...
	k.is = function(a, b) {
		...
		return b == "null" && a === null || b == typeof a || b == "object"
				...
				&& Array.isArray(a)
				|| sb.call(a).slice(8, -1).toLowerCase() == b
	};
	...
	var Aa = function(a) {
		if (k.vml) {
			...
			Aa = q(function(h) {
				g.style.color = h;
				return y.defaultView.getComputedStyle(g, "").getPropertyValue(
						"color")
			})
		}
		return Aa(a)
	...
	k.hsl2rgb = function(a, b, c, e) {
		...
		if (b) {
			...
			for (var h = 0; h < 3; h++) {
				...
				c < 0 && c++;
				c > 1 && c--;
				c * 6 < 1 ? (f[d[h]] = b + (g - b) * 6 * c)
						: c * 2 < 1 ? (f[d[h]] = g) : c * 3 < 2 ? (f[d[h]] = b
								+ (g - b) * (2 / 3 - c) * 6) : (f[d[h]] = b)
			}
		} else
			f = {
	...
	k.getRGB = q(function(a) {
		...
		!(xb[u](a.toLowerCase().substring(0, 2)) || a.charAt() == "#")
				&& (a = Aa(a));
		var b, c, e, f, d;
		if (a = a.match(tb)) {
			if (a[2]) {
			...
			a.hex = "#"
					+ (16777216 | e | c << 8 | b << 16).toString(16).slice(1);
	...
	k.findDotsAtSegment = function(a, b, c, e, f, d, g, h, j) {
		var i = 1 - j, l = Q(i, 3) * a + Q(i, 2) * 3 * j * c + i * 3 * j * j
				* f + Q(j, 3) * g;
		i = Q(i, 3) * b + Q(i, 2) * 3 * j * e + i * 3 * j * j * d + Q(j, 3) * h;
		var m = a + 2 * j * (c - a) + j * j * (f - 2 * c + a), n = b + 2 * j
				* (e - b) + j * j * (d - 2 * e + b), o = c + 2 * j * (f - c)
				+ j * j * (g - 2 * f + c), s = e + 2 * j * (d - e) + j * j
				* (h - 2 * d + e);
		a = (1 - j) * a + j * c;
		b = (1 - j) * b + j * e;
		f = (1 - j) * f + j * g;
	...
	var Da = q(function(a) {
		...
		a = Ca(a);
		for (var b = 0, c = 0, e = [], f = [], d, g = 0, h = a[v]; g < h; g++) {
			d = a[g];
			if (d[0] == "M") {
				b = d[1];
				c = d[2];
		...
		var b = [];
		if (!k.is(a, da) || !k.is(a && a[0], da))
			a = k.parsePathString(a);
		for (var c = 0, e = a[v]; c < e; c++) {
			b[c] = [];
			for (var f = 0, d = a[c][v]; f < d; f++)
				b[c][f] = a[c][f]
		}
		b[ka] = k._path2string;
		return b
		...
		for (var h = a[v]; g < h; g++) {
			...
			if (i[0] != pa.call(i[0])) {
				...
				case "m":
					...
					d = i[2];
				default:
					for (var l = 1, m = i[v]; l < m; l++)
						j[l] = +(i[l] - (l % 2 ? c : e)).toFixed(3)
				}
			} else {
				b[g] = [];
				if (i[0] == "m") {
		...
		var g = 1 / 3, h = 2 / 3;
		return [ g * a + h * c, g * b + h * e, g * f + h * c, g * d + h * e, f,
				d ]
	}, $a = function(a, b, c, e, f, d, g, h, j, i) {
		var l = aa * 120 / 180, m = aa / 180 * (+f || 0), n = [], o, s = q(function(
				T, S, U) {
		...
		if (i) {
			...
			E = e * e;
			z = (d == g ? -1 : 1)
					* G.sqrt(W((z * E - z * A * A - E * o * o)
							/ (z * A * A + E * o * o)));
			d = z * c * A / e + (a + h) / 2;
			var E = z * -e * o / c + (b + j) / 2, A = G.asin(((b - E) / e)
					.toFixed(9));
		...
		a[1] = 2 * e[1] - a[1];
		if (i)
			return [ a, b, h ].concat(n);
		n = [ a, b, h ].concat(n)[Y]().split(",");
		i = [];
		h = 0;
		for (j = n[v]; h < j; h++)
			i[h] = h % 2 ? s(n[h - 1], n[h], m).y : s(n[h], n[h + 1], m).x;
		return i
	}, Fa = function(a, b, c, e, f, d, g, h, j) {
		var i = 1 - j;
		return {
			x : Q(i, 3) * a + Q(i, 2) * 3 * j * c + i * 3 * j * j * f + Q(j, 3)
					* g,
			y : Q(i, 3) * b + Q(i, 2) * 3 * j * e + i * 3 * j * j * d + Q(j, 3)
					* h
		}
	}, Eb = q(function(a, b, c, e, f, d, g, h) {
		var j = f - 2 * c + a - (g - 2 * f + c), i = 2 * (c - a) - 2 * (f - c), l = a
				- c, m = (-i + G.sqrt(i * i - 4 * j * l)) / 2 / j;
		...
		var f = function(o, s) {
			var z;
			if (!o)
				return [ "C", s.x, s.y, s.x, s.y, s.x, s.y ];
			!(o[0] in {
				T : 1,
				Q : 1
			}) && (s.qx = s.qy = null);
			...
			case "M":
				...
				break;
			case "A":
				o = [ "C" ].concat($a[M](0, [ s.x, s.y ].concat(o.slice(1))));
				break;
			case "S":
				z = s.x + (s.x - (s.bx || s.x));
				s = s.y + (s.y - (s.by || s.y));
			...
			case "Q":
				...
				break;
			case "L":
				o = [ "C" ].concat(Ea(s.x, s.y, o[1], o[2]));
				break;
			case "H":
				o = [ "C" ].concat(Ea(s.x, s.y, o[1], s.y));
				break;
			case "V":
				o = [ "C" ].concat(Ea(s.x, s.y, s.x, o[1]));
				break;
			case "Z":
				o = [ "C" ].concat(Ea(s.x, s.y, s.X, s.Y));
				break
			}
			return o
		}, d = function(o, s) {
	...
	if (k.svg) {
		...
		var hb = function(a, b) {
			...
			b = D(b).replace(
					...
					function(l, m, n) {
						...
						if (m && n) {
							...
							d = F(n);
							l = (d > 0.5) * 2 - 1;
							Q(f - 0.5, 2) + Q(d - 0.5, 2) > 0.25
									&& (d = G.sqrt(0.25 - Q(f - 0.5, 2)) * l
											+ 0.5) && d != 0.5
									&& (d = d.toFixed(5) - 1.0E-5 * l)
						}
						return ""
					});
			b = b.split(/\s*\-\s*/);
			...
			(j = j.match(/^url\(#(.*)\)$/))
					&& c.defs.removeChild(y.getElementById(j[1]));
			j = B(e + "Gradient");
			j.id = t();
			B(j, e == "radial" ? {
				fx : f,
			...
			for (h = b[v]; c < h; c++) {
				var i = B("stop");
				B(i, {
					offset : b[c].offset ? b[c].offset : c ? "100%" : "0%",
			...
			var b = a.getBBox();
			B(a.pattern, {
				patternTransform : k.format("translate({0},{1})", b.x, b.y)
			})
		}, ma = function(a, b) {
			var c = {
				"" : [ 0 ],
				...
				if (b[u](j))
					if (za[u](j)) {
						...
						case "target":
							...
							j == "target" && i == "blank" ? l.setAttributeNS(
									a.paper.xlink, "show", "new") : l
									.setAttributeNS(a.paper.xlink, j, i);
							break;
						case "cursor":
							e.style.cursor = i;
							break;
						case "clip-rect":
							...
							if (!i) {
								(i = y.getElementById(e.getAttribute(
						...
						case "width":
							...
							if (f.fx) {
								...
								break;
						case "x":
							f.fx && (i = -f.x - (f.width || 0));
						case "rx":
							if (j == "rx" && a.type == "rect")
								break;
						case "cx":
							h && (j == "x" || j == "cx") && (h[1] += i - f[j]);
							e.setAttribute(j, i);
							a.pattern && Pa(a);
							break;
						case "height":
							...
							if (f.fy) {
								...
								break;
						case "y":
							f.fy && (i = -f.y - (f.height || 0));
						case "ry":
							if (j == "ry" && a.type == "rect")
								break;
						case "cy":
							h && (j == "y" || j == "cy") && (h[2] += i - f[j]);
							e.setAttribute(j, i);
							a.pattern && Pa(a);
							break;
						case "r":
						...
						case "src":
							a.type == "image"
									&& e.setAttributeNS(a.paper.xlink, "href",
											i);
							break;
						case "stroke-width":
							e.style.strokeWidth = i;
							e.setAttribute(j, i);
							f["stroke-dasharray"]
						...
						case "scale":
							i = D(i).split(C);
							a.scale(+i[0] || 1, +i[1] || +i[0] || 1,
									isNaN(F(i[2])) ? null : +i[2],
									isNaN(F(i[3])) ? null : +i[3]);
							break;
						case "fill":
							if (l = D(i).match(Wa)) {
								n = B("pattern");
							...
							if (l.error)
								if (({
									...
									delete b.gradient;
									delete f.gradient;
									!k.is(f.opacity, "undefined")
											&& k.is(b.opacity, "undefined")
											&& B(e, {
												opacity : f.opacity
											});
									!k.is(f["fill-opacity"], "undefined")
											&& k.is(b["fill-opacity"],
													"undefined")
											&& B(
													e,
							...
							l[u]("opacity")
									&& B(
											e,
											{
												"fill-opacity" : l.opacity > 1 ? l.opacity / 100
														: l.opacity
											});
						case "stroke":
							l = k.getRGB(i);
							...
							j == "stroke"
									...
									&& B(
											e,
											{
												"stroke-opacity" : l.opacity > 1 ? l.opacity / 100
														: l.opacity
											});
							break;
						case "gradient":
							...
							break;
						case "opacity":
							f.gradient && !f[u]("stroke-opacity") && B(e, {
								"stroke-opacity" : i > 1 ? i / 100 : i
							});
						case "fill-opacity":
							if (f.gradient) {
								if (l = y.getElementById(e.getAttribute("fill")
										.replace(/^url\(#|\)$/g, ""))) {
			...
			if (!(a.type != "text" || !(b[u]("text") || b[u]("font")
					|| b[u]("font-size") || b[u]("x") || b[u]("y")))) {
				var c = a.attrs, e = a.node, f = e.firstChild ? la(
						y.defaultView.getComputedStyle(e.firstChild, "")
								.getPropertyValue("font-size"), 10) : 10;
				if (b[u]("text")) {
					for (c.text = b.text; e.firstChild;)
						e.removeChild(e.firstChild);
					b = D(b.text).split("\n");
					for (var d = 0, g = b[v]; d < g; d++)
						if (b[d]) {
							var h = B("tspan");
							d && B(h, {
								dy : f * 1.2,
		...
		L[p].rotate = function(a, b, c) {
			...
			if (a == null) {
				if (this._.rt.cx)
					return [ this._.rt.deg, this._.rt.cx, this._.rt.cy ][Y](V);
			...
			a = F(a[0]);
			b != null && b !== false ? (this._.rt.deg = a)
					: (this._.rt.deg += a);
			c == null && (b = null);
			this._.rt.cx = b;
			this._.rt.cy = c;
			...
			if (this._.rt.deg) {
				this.transformations[0] = k.format("rotate({0} {1} {2})",
						this._.rt.deg, b, c);
				this.clip
						&& B(this.clip, {
							transform : k.format("rotate({0} {1} {2})",
									-this._.rt.deg, b, c)
						})
			} else {
		...
		L[p].getBBox = function() {
			...
			if (this.type == "text") {
				...
				for (var e = 0, f = this.node.getNumberOfChars(); e < f; e++) {
					var d = this.node.getExtentOfChar(e);
					d.y < b.y && (b.y = d.y);
					d.y + d.height - b.y > b.height
							&& (b.height = d.y + d.height - b.y);
					d.x + d.width - b.x > b.width
							&& (b.width = d.x + d.width - b.x)
				}
			}
			a && this.hide();
			return b
		...
		L[p].attr = function(a, b) {
			...
			if (a == null) {
				...
				for ( var c in this.attrs)
					this.attrs[u](c) && (a[c] = this.attrs[c]);
			...
			if (b != null) {
				...
				a != null && k.is(a, "object") && (e = a);
			for (f in this.paper.customAttributes)
				if (this.paper.customAttributes[u](f) && e[u](f)
						&& k.is(this.paper.customAttributes[f], "function")) {
					a = this.paper.customAttributes[f].apply(this, []
							.concat(e[f]));
					this.attrs[f] = e[f];
					for ( var d in a)
						a[u](d) && (e[d] = a[d])
		...
		var ib = function(a, b, c, e) {
			...
			if (b == 1) {
				d.style.cssText = "position:absolute;left:" + c + "px;top:" + e
						+ "px";
				y.body.appendChild(d)
			} else
				b.firstChild ? b.insertBefore(d, b.firstChild) : b
						.appendChild(d);
			b = new na;
			b.width = f;
			b.height = a;
		...
		P.clear = function() {
			...
			(this.desc = B("desc")).appendChild(y
	...
	if (k.vml) {
		var ob = {
			...
			b = /[clmz]/g;
			if (c == ua && !D(a).match(b))
				return a = D(a).replace(Gb, function(j, i, l) {
			...
			var e;
			a = [];
			for (var f = 0, d = b[v]; f < d; f++) {
				c = b[f];
				e = pa.call(b[f][0]);
				e == "z" && (e = "x");
				for (var g = 1, h = c[v]; g < h; g++)
					e += Z(c[g] * 10) + (g != h - 1 ? "," : "");
				a[N](e)
			}
			return a[Y](V)
		...
		ma = function(a, b) {
			...
			d = (b.x != e.x || b.y != e.y || b.width != e.width
					|| b.height != e.height || b.r != e.r)
					&& a.type == "rect";
			for ( var g in b)
				b[u](g) && (e[g] = b[g]);
			if (d) {
			...
			if (b.scale) {
				d = D(b.scale).split(C);
				a.scale(+d[0] || 1, +d[1] || +d[0] || 1, +d[2] || null, +d[3]
						|| null)
			}
			if ("clip-rect" in b) {
				...
				if (d[v] == 4) {
					...
					h.clip = k.format("rect({1}px {2}px {3}px {0}px)", d);
					if (!c.clipRect) {
						h.position = "absolute";
						h.top = 0;
						h.left = 0;
			...
			if (a.type == "image" && b.opacity) {
				c.filterOpacity = " progid:DXImageTransform.Microsoft.Alpha(opacity="
						+ b.opacity * 100 + ")";
			...
			if (b.opacity != null || b["stroke-width"] != null
				...
				c = a.shape || c;
				d = c.getElementsByTagName("fill")
						&& c.getElementsByTagName("fill")[0];
				g = false;
				!d && (g = d = ba("fill"));
				if ("fill-opacity" in b || "opacity" in b) {
					f = ((+e["fill-opacity"] + 1 || 2) - 1)
							* ((+e.opacity + 1 || 2) - 1)
							* ((+k.getRGB(b.fill).o + 1 || 2) - 1);
					f = ja(ca(f, 0), 1);
					d.opacity = f
				}
				b.fill && (d.on = true);
				if (d.on == null || b.fill == "none")
					d.on = false;
				if (d.on && b.fill)
					if (f = b.fill.match(Wa)) {
						d.src = f[1];
						d.type = "tile"
					} else {
				...
				g && c.appendChild(d);
				d = c.getElementsByTagName("stroke")
				...
				if (b.stroke && b.stroke != "none" || b["stroke-width"]
						...
						|| b["stroke-linecap"])
					d.on = true;
				(b.stroke == "none" || d.on == null || b.stroke == 0 || b["stroke-width"] == 0)
						&& (d.on = false);
				f = k.getRGB(b.stroke);
				d.on && b.stroke && (d.color = f.hex);
				f = ((+e["stroke-opacity"] + 1 || 2) - 1)
						* ((+e.opacity + 1 || 2) - 1) * ((+f.o + 1 || 2) - 1);
				...
				d.opacity = f;
				b["stroke-linejoin"]
						&& (d.joinstyle = b["stroke-linejoin"] || "miter");
				d.miterlimit = b["stroke-miterlimit"] || 8;
				b["stroke-linecap"]
						&& (d.endcap = b["stroke-linecap"] == "butt" ? "flat"
			...
			if (a.type == "text") {
				...
				a.node.string
						&& (a.paper.span.innerHTML = D(a.node.string).replace(
								/</g, "&#60;").replace(/&/g, "&#38;").replace(
								/\n/g, "<br>"));
		...
		va = function(a, b) {
			...
			b = D(b).replace(
					...
					function(j, i, l) {
						...
						if (i && l) {
							i = F(i);
							l = F(l);
							Q(i - 0.5, 2) + Q(l - 0.5, 2) > 0.25
									&& (l = G.sqrt(0.25 - Q(i - 0.5, 2))
											* ((l > 0.5) * 2 - 1) + 0.5);
							e = i + V + l
						}
						return ""
			...
			if (d[v]) {
				...
				a = [];
				for (var g = 0, h = d[v]; g < h; g++)
					d[g].offset && a[N](d[g].offset + V + d[g].color);
		...
		I.setBox = function(a, b, c) {
			if (this.removed)
				return this;
			var e = this.Group.style, f = this.shape && this.shape.style
					|| this.node.style;
			a = a || {};
			for ( var d in a)
				a[u](d) && (this.attrs[d] = a[d]);
			b = b || this._.rt.cx;
			c = c || this._.rt.cy;
			var g = this.attrs, h;
			switch (this.type) {
			...
			case "image":
				...
				break;
			case "text":
				this.textpath.v = [ "m", Z(g.x), ", ", Z(g.y - 2), "l",
						Z(g.x) + 1, ", ", Z(g.y - 2) ][Y]("");
				a = g.x - Z(this.W / 2);
				d = g.y - this.H / 2;
				h = this.W;
		...
		I.attr = function(a, b) {
			...
			if (e) {
				for (f in this.paper.customAttributes)
					if (this.paper.customAttributes[u](f) && e[u](f)
							&& k.is(this.paper.customAttributes[f], "function")) {
						c = this.paper.customAttributes[f].apply(this, []
								.concat(e[f]));
						this.attrs[f] = e[f];
						for ( var d in c)
							c[u](d) && (e[d] = c[d])
				...
				e.gradient && ({
					circle : 1,
					ellipse : 1
				}[u](this.type) || D(e.gradient).charAt() != "r")
						&& va(this, e.gradient);
		...
		I.blur = function(a) {
			...
			if (+a !== 0) {
				...
				b.filter = c
						...
						+ (+a || 1.5) + ")";
				b.margin = k.format("-{0}px 0 0 -{0}px", Z(+a || 1.5))
			} else {
				b.filter = c;
				b.margin = 0;
				delete this.attrs.blur
		...
		var pb = function(a, b, c, e, f) {
			return f ? k
					.format(
							...
							a + f, b, c - f * 2, f, -f, e - f * 2, f * 2 - c, f
									* 2 - e)
					: k.format("M{0},{1}l{2},0,0,{3},{4},0z", a, b, c, e, -c)
		};
		jb = function(a, b, c, e, f, d) {
			var g = pb(b, c, e, f, d);
			a = a.path(g);
		...
		kb = function(a, b, c, e, f) {
			...
			d.style.cssText = "position:absolute;left:0;top:0;width:" + a.width
					+ "px;height:" + a.height + "px";
			d.coordsize = wa;
		...
		mb = function(a, b, c, e) {
			...
			f.coordsize = wa;
			f.coordorigin = a.coordorigin;
			h.v = k.format("m{0},{1}l{2},{1}", Z(b * 10), Z(c * 10),
					Z(b * 10) + 1);
			h.textpathok = true;
			g.width = a.width;
			g.height = a.height;
		...
		Ja = function() {
			...
			if (b == 1) {
				...
				b.firstChild ? b.insertBefore(g, b.firstChild) : b
						.appendChild(g);
			Oa.call(d, d, k.fn);
			return d
		};
	...
	navigator.vendor == "Apple Computer, Inc."
			&& (ga && ga[1] < 4 || navigator.platform.slice(0, 2) == "iP") ? (P.safari = function() {
	...
	var Kb = function() {
		...
		if (y.addEventListener)
			return function(a, b, c, e) {
				var f = oa && Ka[b] ? Ka[b] : b, d = function(g) {
					if (oa && Ka[u](b))
						for (var h = 0, j = g.targetTouches
								&& g.targetTouches.length; h < j; h++)
		...
		for (var b = a.clientX, c = a.clientY, e = y.documentElement.scrollTop
				|| y.body.scrollTop, f = y.documentElement.scrollLeft
				|| y.body.scrollLeft, d, g = ha.length; g--;) {
			d = ha[g];
			if (oa)
				for (var h = a.touches.length, j; h--;) {
					j = a.touches[h];
			...
			c += e;
			d.move
					&& d.move.call(d.move_scope || d.el, b - d.el._drag.x, c
							- d.el._drag.y, b, c, a)
		}
	}, Ra = function(a) {
		k.unmousemove(Qa).unmouseup(Ra);
		for (var b = ha.length, c; b--;) {
			c = ha[b];
			c.el._drag = {};
			c.end
					&& c.end.call(c.end_scope || c.start_scope || c.move_scope
							|| c.el, a)
		}
		ha = []
	};
			...
			k[a] = L[p][a] = function(b, c) {
				if (k.is(b, "function")) {
					...
					this.events.push({
						name : a,
						f : b,
						unbind : Ob(this.shape || this.node || y, a, b, c
								|| this)
					})
				}
				return this
	...
	I.drag = function(a, b, c, e, f, d) {
		...
		this
				.mousedown(function(g) {
					...
					var h = y.documentElement.scrollTop || y.body.scrollTop, j = y.documentElement.scrollLeft
							|| y.body.scrollLeft;
					this._drag.x = g.clientX + j;
					this._drag.y = g.clientY + h;
					this._drag.id = g.identifier;
					b
							&& b.call(f || e || this, g.clientX + j, g.clientY
									+ h, g);
	...
	I.undrag = function(a, b, c) {
		for (b = ha.length; b--;)
			ha[b].el == this && ha[b].move == a && ha[b].end == c
					&& ha.splice(b++, 1);
	...
	P.set = function(a) {
		arguments[v] > 1
				&& (a = Array[p].splice.call(arguments, 0, arguments[v]));
		return new ea(a)
	};
	P.setSize = nb;
	P.top = P.bottom = null;
	...
	I.scale = function(a, b, c, e) {
		...
		if (a != 0) {
			var h = this.getBBox(), j = h.x + h.width / 2, i = h.y + h.height
					/ 2;
			f = W(a / this._.sx);
			d = W(b / this._.sy);
			c = +c || c == 0 ? c : j;
			...
			if (this.type in {
				...
				if (this.transformations) {
					...
					this.node.filterMatrix = " progid:DXImageTransform.Microsoft"
							+ ".Matrix(M11="
									.concat(h, ", M12=0, M21=0, M22=", n,
	...
	var Sa = {}, Ha = function(a, b, c, e, f, d, g, h, j) {
	...
	sa = function(a, b) {
		return function(c, e, f) {
			c = Ca(c);
			for (var d, g, h, j, i = "", l = {}, m = 0, n = 0, o = c.length; n < o; n++) {
				h = c[n];
				if (h[0] == "M") {
					d = +h[1];
					g = +h[2]
					...
					if (m + j > e) {
						if (b && !l.start) {
							d = Ha(d, g, h[1], h[2], h[3], h[4], h[5], h[6], e
									- m);
							i += [ "C", d.start.x, d.start.y, d.m.x, d.m.y,
									d.x, d.y ];
							if (f)
								return i;
							l.start = i;
							i = [ "M", d.x, d.y + "C", d.n.x, d.n.y, d.end.x,
									d.end.y, h[5], h[6] ][Y]();
							m += j;
							d = +h[5];
							g = +h[6];
			...
			l.end = i;
			d = a ? m : b ? l : k.findDotsAtSegment(d, g, h[1], h[2], h[3],
					h[4], h[5], h[6], 1);
			d.alpha && (d = {
				x : d.x,
				y : d.y,
	...
	I.getPointAtLength = function(a) {
		if (this.type == "path")
			return Ia(this.attrs.path, a)
	};
	I.getSubpath = function(a, b) {
		if (this.type == "path") {
			if (W(this.getTotalLength() - b) < "1e-6")
				return Ta(this.attrs.path, a).end;
	...
	var ia = [], rb = function() {
		for (var a = +new Date, b = 0; b < ia[v]; b++) {
			var c = ia[b];
				...
				if (e < f) {
					...
					for ( var n in g)
						if (g[u](n)) {
							...
							case "colour":
								m = "rgb("
										+ [ Ua(Z(g[n].r + e * f * h[n].r)),
												Ua(Z(g[n].g + e * f * h[n].g)),
												Ua(Z(g[n].b + e * f * h[n].b)) ][Y]
												(",") + ")";
								break;
							case "path":
								m = [];
								d = 0;
								for (var o = g[n][v]; d < o; d++) {
									m[d] = [ g[n][d][0] ];
									for (var s = 1, z = g[n][d][v]; s < z; s++)
										m[d][s] = +g[n][d][s] + e * f
												* h[n][d][s];
									m[d] = m[d][Y](V)
								}
							...
							default:
								o = [].concat(g[n]);
								m = [];
								for (d = l.paper.customAttributes[n].length; d--;)
									m[d] = +o[d] + e * f * h[n][d];
								break
							}
							c[n] = m
					...
					if (j.along) {
						...
						l.translate(h.sx - (h.x || 0) + d.x - h.sx, h.sy
								- (h.y || 0) + d.y - h.sy);
						j.rot && l.rotate(h.r + d.alpha, d.x, d.y)
					}
	...
	I.animateWith = function(a, b, c, e, f) {
		for (var d = 0, g = ia.length; d < g; d++)
			ia[d].el.id == a.id && (b.start = ia[d].start);
	...
	I.animate = function(a, b, c, e) {
		...
		for ( var i in a)
			if (a[u](i))
				if (La[u](i) || f.paper.customAttributes[u](i)) {
					h = true;
					d[i] = f.attr(i);
					d[i] == null && (d[i] = za[i]);
					g[i] = a[i];
					switch (La[i]) {
					case "along":
						var l = qb(a[i]), m = Ia(a[i], l * !!a.back), n = f
								.getBBox();
						j[i] = l / b;
						j.tx = n.x;
						j.ty = n.y;
					...
					case "path":
						...
						for (m = d[i][v]; l < m; l++) {
							j[i][l] = [ 0 ];
							for (var o = 1, s = d[i][l][v]; o < s; o++)
								j[i][l][o] = (n[l][o] - d[i][l][o]) / b
						}
						break;
					case "csv":
						m = D(a[i]).split(C);
					...
					default:
						...
						n = [].concat(d[i]);
						j[i] = [];
						for (l = f.paper.customAttributes[i][v]; l--;)
							j[i][l] = ((m[l] || 0) - (n[l] || 0)) / b;
						break
					}
				}
		if (h) {
			...
			l = 0;
			for (m = c[v]; l < m; l++)
				Pb(c[l].value, f, b / 100 * c[l].key, b / 100
						* (c[l - 1] && c[l - 1].key || 0), c[l - 1]
						&& c[l - 1].value.callback);
			(E = c[c[v] - 1].value.callback)
					&& f.timeouts.push(setTimeout(function() {
						E.call(f)
					}, b))
		}
		return this
	...
	I.stop = function() {
		for (var a = 0; a < ia.length; a++)
			ia[a].el.id == this.id && ia.splice(a--, 1);
		a = 0;
		for (ii = this.timeouts && this.timeouts.length; a < ii; a++)
	...
	var ea = function(a) {
		...
		this.type = "set";
		if (a)
			for (var b = 0, c = a[v]; b < c; b++)
				if (a[b] && (a[b].constructor == L || a[b].constructor == ea)) {
					this[this.items[v]] = this.items[this.items[v]] = a[b];
					this[v]++
				}
	};
	ea[p][N] = function() {
		for (var a, b, c = 0, e = arguments[v]; c < e; c++)
			if ((a = arguments[c])
					&& (a.constructor == L || a.constructor == ea)) {
				b = this.items[v];
	...
	for ( var Va in I)
		I[u](Va) && (ea[p][Va] = function(a) {
			return function() {
				for (var b = 0, c = this.items[v]; b < c; b++)
	...
	ea[p].animate = function(a, b, c, e) {
		...
		c = k.is(c, "string") ? c : j;
		for (g = this.items[--d].animate(a, b, c, j); d--;)
			this.items[d] && !this.items[d].removed
					&& this.items[d].animateWith(g, a, b, c, j);
		return this
	};
	ea[p].insertAfter = function(a) {
		for (var b = this.items[v]; b--;)
			this.items[b].insertAfter(a);
		return this
	};
	ea[p].getBBox = function() {
		for (var a = [], b = [], c = [], e = [], f = this.items[v]; f--;) {
	...
	P.print = function(a, b, c, e, f, d, g) {
		...
		if (e) {
			...
			f = +l[0];
			d = +l[1]
					+ (d == "baseline" ? l[3] - l[1] + +e.face.descent
							: (l[3] - l[1]) / 2);
			l = 0;
			for (var m = j[v]; l < m; l++) {
				var n = l && e.glyphs[j[l - 1]] || {}, o = e.glyphs[j[l]];
	...
	k.format = function(a, b) {
		...
		a && k.is(a, "string") && c[v] - 1
				&& (a = a.replace(qa, function(e, f) {
					return c[++f] == null ? "" : c[f]
				}));
		return a || ""
	};
	...
	return Class.extend({
		...
		transform : function() {
			function k(O) {
				$("#" + t).css(
						O + "transform",
						"translateX(" + q + "px) translateY(" + w
								+ "px) scale(" + K + ") rotate(" + r + "deg)")
			}
		...
		function(k, t) {
			return Class
					.extend({
						...
						init : function() {
							this.planets = {
								mercury : new t("mercury", 0.4, 0),
								venus : new t("venus", 0.9, 0),
								earth : new t("earth", 1, 0),
								mars : new t("mars", 0.53, 0),
								jupiter : new t("jupiter", 11.2, 0),
								saturn : new t("saturn", 9.4, 90),
								uranus : new t("uranus", 4, 0),
								neptune : new t("neptune", 3.8, 0)
							};
							this.planetPositions = {};
							this.planetsOrder = [ "mercury", "venus", "earth",
									"mars", "jupiter", "saturn", "uranus",
									"neptune" ];
							this.planetsDistance = [ 46001200, 107476259,
									147098290, 206669E3, 740573600, 1353572956,
									2748938461, 4452940833 ];
							this.distance = 100;
							this.multiplier = 1
						},
						...
						getPlanetIndex : function(q) {
							for (var w = 0; w < this.planetsOrder.length; w++)
								if (this.planetsOrder[w] === q)
									return w;
							return -1
						},
						getPlanetNameAt : function(q) {
							if (q < 0 || q > this.planetsOrder.length - 1)
						...
						forEachPlanet : function(q) {
							for (var w = 0; w < this.planetsOrder.length; w++)
								q(this.getPlanet(this.planetsOrder[w]))
						},
						forEachPlanetBefore : function(q, w) {
							for (var K = 0; K < this.planetsOrder.length; K++) {
						...
						fit : function(q, w) {
							this.distance = q < 1100 ? 60 : q < 1300 ? 70
									: q < 1500 ? 80 : 100;
							var K = this.planetsOrder.length, O = q - K
									* this.distance, C = 0;
							if (O > q || O < 0) {
								this.distance = 100;
								O = q - K * this.distance
						...
						getPlanetDiameter : function(q) {
							return this.getPlanet(q).getDiameter(
									this.multiplier)
						},
...
define("camera", [ "constants" ], function(k) {
	return Class.extend({
		...
		focusPlanet : function(t) {
			...
			this.system.move(-this.system.getDistanceTo(t) - k.IMG_SIZE * w,
					this.h / 2 - k.IMG_SIZE / 2);
		...
		focusNextPlanet : function() {
			var t = this._focusedPlanetIndex + 1, q = this.system
					.getNbPlanets() - 1;
...
define("satellites", [ "raphael" ], function(k) {
	return Class.extend({
		...
		init : function(t, q, w, K) {
			...
			this.planetStyle = {
				"stroke-width" : 0,
				fill : this.DEFAULT_PLANET_COLOR
			};
		...
		forEachSatellite : function(t) {
			for ( var q in this.satellites)
				this.satellites.hasOwnProperty(q) && t(this.satellites[q])
		},
		drawPlanet : function() {
			this.r.circle(this.x, this.y, this.planetRadius).attr(
					this.planetStyle)
		},
		drawOrbits : function() {
...
define("counter", [ "jquery" ], function(k) {
	return Class.extend({
		...
		zeroFill : function(t, q) {
			q -= t.toString().length;
			if (q > 0)
				return (new Array(q + (/\./.test(t) ? 2 : 1))).join("0") + t;
			return t
		},
		run : function() {
...
define(
		"planetarium",
		[ "raphael", "constants", "solarsystem", "camera", "satellites",
				"counter" ],
		function(k, t, q, w, K, O) {
			k = Class
					.extend({
						init : function() {
						...
						run : function() {
							...
							this.earthGraph = new fa("earth-moon", 130, 130,
									1.06);
							this.jupiterGraph = new C("galilean-moons", 500,
									330, 0.7);
						...
						toggleBodyClass : function() {
							var p = this.camera.getCurrentView(), u = this.camera
									.getFocusedPlanet().getName();
							p === t.VIEW.SYSTEM ? $("body").removeClass(u)
									.addClass("system") : $("body").addClass(u)
									.removeClass("system")
						},
						getCurrentView : function() {
						...
						onCurrentPlanetTransitionOver : function(p) {
							var u = this.camera.getFocusedPlanet().getName(), y = $("#"
									+ u + "-info"), H = function() {
								p();
						...
						updateGalleryUI : function() {
							this.userHasZoomedOnce
									&& this.changeview_callback(this
											.getCurrentView())
						},
						isPreviousPlanet : function() {
							return this.system.getPlanetIndex(this.camera
									.getFocusedPlanet().getName()) > 0
						},
						isNextPlanet : function() {
							return this.system.getPlanetIndex(this.camera
									.getFocusedPlanet().getName()) < 7
						},
						getPreviousPlanetName : function() {
							return this.system.getPlanetNameAt(this.system
									.getPlanetIndex(this.camera
											.getFocusedPlanet().getName()) - 1)
						},
						...
						nextPlanet : function() {
							var p = "", u = $("body");
							if (!this.moving
									&& this.camera.getCurrentView() === t.VIEW.PLANET
									&& this.isNextPlanet()) {
						...
						disableTransitions : function() {
							function p(u) {
								$("li.planet").css(u + "transition-duration",
										"0s")
							}
							p("-moz-");
							p("-webkit-");
						...
						createCounter : function(p, u) {
							...
							this.distanceCounter = new O($("#counters").get(0),
									p, u);
						...
						showPlanetInfo : function() {
							var p = this.camera.getFocusedPlanet().getName(), u = this.currentKm, y = this.system
									.getPlanetDistanceToSun(this.system
											.getPlanetIndex(p)), H = $("#gui");
							H.addClass("visible");
						...
						updateGraphs : function() {
							...
							if (this.camera.getCurrentView() === t.VIEW.PLANET)
								if (p === "jupiter")
						...
						forPlanetsOnLeft : function(p) {
							for (var u = this, y = this.system
									.getPlanetIndex(this.camera
											.getFocusedPlanet().getName()) - 1; y >= 0; y -= 1)
								(function(H) {
						...
						forPlanetsOnRight : function(p) {
							for (var u = this, y = this.system
									.getPlanetIndex(this.camera
											.getFocusedPlanet().getName()) + 1; y < 8; y += 1)
								(function(H) {
									H = u.system.getPlanetNameAt(H);
									p(H)
								})(y)
					...
					.ready(
							function() {
								...
								var w = null, K = false, O = {
									...
									for (var H = [ "mercury.jpg", "venus.jpg",
											"earth.jpg", "mars.jpg",
											"jupiter.jpg", "saturn.png",
											"uranus.png", "neptune.jpg" ], J = 0, na = 0, P = H.length; na < P; na += 1) {
										var M = H[na], oa = M.split(".")[0], V = M
												.split(".")[1];
										oa = k("#" + oa);
									...
									w.onChangeView(function(J) {
										J === t.VIEW.SYSTEM ? C("show_exit_ui")
												: C("hide_exit_ui")
									});
									w.run();
									...
									k("#back")
											.click(
													function() {
														w.getCurrentView() === t.VIEW.PLANET
																&& w
																		.showSystemView()
													});
									k("li.planet")
											.click(
													function() {
														w.getCurrentView() === t.VIEW.SYSTEM
																&& w
																		.zoomOnPlanet(this.id)
													});
											...
											.bind(
													...
													function(J) {
														...
														if ([ 32, 37, 38, 39,
															...
															case 38:
																w
																		.getCurrentView() === t.VIEW.SYSTEM
																		&& w
																				.showPlanetView();
																break;
															case 40:
																w
																		.getCurrentView() === t.VIEW.PLANET
																		&& w
																				.showSystemView();
																break
															}
									...
									setTimeout(function() {
										k("#instructions").removeClass(
												"loading");
										setTimeout(function() {
											k("#toggle-credits").removeClass(
													"loading")
										}, 800)
									}, 1E3)
								};
...
(function() {
	...
	Class.extend = function(q) {
		...
		k = false;
		for ( var C in q)
			O[C] = typeof q[C] == "function" && typeof K[C] == "function"
					&& t.test(q[C]) ? function(fa, qa) {
				return function() {
					var p = this._super;
					this._super = K[fa];
